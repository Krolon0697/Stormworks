...
Krolony.Fourier={
	...
	fftUniRadix=function(input,inverse,disableAutoNormalization,customRadices)
		...
		if UniqueNameFFTCRMemoryKrolon==nil then UniqueNameFFTCRMemoryKrolon={space={{},{}},orders={},[true]={},[false]={}} end
		local N,inverse,mem,factors,factor,twiddles,helper1,helper2,oldLayer,newLayer,V,A,B,Ar,Aim,Br,Bim,r,im,permutation,size=#input+(input[0] and 1 or 0),inverse or false,UniqueNameFFTCRMemoryKrolon
